      ...
      <body className={`${inter.className}`}>
        <main className="  overflow-x-hidden flex justify-center w-screen h-fit min-h-screen bg-slate-50 text-slate-900 dark:bg-slate-900 dark:text-slate-100">
          ...
          <div className="h-screen w-screen flex flex-col lg:flex-row">
            <aside className="bg-slate-50 text-slate-900 dark:bg-slate-900 dark:text-slate-100 absolute z-50 pb-4 w-screen flex flex-col lg:pl-6 lg:w-52 lg:h-full lg:left-0 justify-between pt-6">
              <div>
