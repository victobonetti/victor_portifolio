export default function Sobre() {
    return (
        <div className=" flex justify-start w-full h-full">
            <div className=" bg-slate-100 w-full md:w-1/2  mx-auto p-8">
                ...
                <div className="mb-4">
                    ...
                    <p className="text-slate-600 italic">Término em 2026</p>
                </div>
                ...
                <div className="mb-6">
                    ...
                    <p>Github</p>
                    <p className="text-slate-600 italic"><a className=" text-blue-500" href="https://github.com/victobonetti" target="_blank" rel="noopener">https://github.com/victobonetti</a></p>
                </div>
